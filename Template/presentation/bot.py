...
from Template.infrastructure.config_loader import load_config
from Template.infrastructure.db.main import get_async_sessionmaker, get_engine

from Template.presentation.telegram import register_handlers, register_dialogs

from Template.presentation.ioc import IoC
